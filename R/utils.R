...
sample_z_loop <- function(N, A, alpha, z, mu_ar, S_ar, mu_a0,
    R_a0, beta_a0, W_a0, nclust) {
    res <- .Call(`_sequenza_sample_z_loop`, N, A, alpha, z, mu_ar,
        S_ar, mu_a0, R_a0, beta_a0, W_a0, nclust)
